...
const validateGroup = (bot, msg, expectedGroupId, moduleName) => {
    ...
    if (!isValid) {
        const warning = telegram_1.RESPONSES.WARNING(`This command is not allowed in this group. Please use it in the appropriate group for ${moduleName} management, or contact an administrator.`);
