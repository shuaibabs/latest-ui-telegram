...
const deleteUserFlow_1 = require("../../flows/users/deleteUserFlow");
function deleteUserCommand(bot) {
    bot.onText(/\/deleteuser/, (0, auth_1.adminOnly)(bot, (msg, _match, _username) => __awaiter(this, void 0, void 0, function* () {
