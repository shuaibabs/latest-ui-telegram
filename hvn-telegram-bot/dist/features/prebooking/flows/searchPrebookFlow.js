...
exports.startSearchPrebookFlow = startSearchPrebookFlow;
exports.registerSearchPrebookFlow = registerSearchPrebookFlow;
...
function startSearchPrebookFlow(bot, chatId) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, sessionManager_1.setSession)(chatId, 'searchPrebook', {
            stage: 'SELECT_TYPE',
            criteria: {}
        });
        yield bot.sendMessage(chatId, "🔍 *Search Pre-bookings*\n\nChoose search type:", {
            parse_mode: 'Markdown',
            reply_markup: {
                inline_keyboard: [
...
function registerSearchPrebookFlow(router) {
    const bot = router.bot;
    bot.on('message', (msg) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const session = (0, sessionManager_1.getSession)(msg.chat.id, 'searchPrebook');
        ...
        if (session.stage === 'AWAIT_CRITERIA_VAL' && session.currentSetting) {
            ...
            (0, sessionManager_1.setSession)(chatId, 'searchPrebook', session);
            ...
            (0, sessionManager_1.clearSession)(chatId, 'searchPrebook');
        }
    }));
    router.registerCallback(/^pb_search_type_/, (query) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPrebook');
        if (!session)
            return;
        ...
        if (type === 'adv') {
            ...
            (0, sessionManager_1.setSession)(chatId, 'searchPrebook', session);
            yield bot.sendMessage(chatId, "*Advanced Pre-booking Search*\nConfigure your filters:", {
                parse_mode: 'Markdown',
                reply_markup: getCriteriaMenu(session.criteria)
            });
        }
    ...
    router.registerCallback(/^pb_search_set_/, (query) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPrebook');
        if (!session || session.stage !== 'ADV_SEARCH_MENU')
            return;
        const key = (_a = query.data) === null || _a === void 0 ? void 0 : _a.replace('pb_search_set_', '');
    ...
    router.registerCallback('pb_search_apply', (query) => __awaiter(this, void 0, void 0, function* () {
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPrebook');
        if (!session)
            return;
    ...
    router.registerCallback('pb_search_cancel', (query) => __awaiter(this, void 0, void 0, function* () {
        (0, sessionManager_1.clearSession)(query.message.chat.id, 'searchPrebook');
...
function performSearch(bot, chatId, criteria, username) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const results = yield (0, prebookingService_1.searchPrebookingNumbers)(criteria, employeeName);
            if (results.length === 0) {
                yield bot.sendMessage(chatId, "🔍 No pre-booked numbers found matching your criteria.");
            }
            else {
            ...
            logger_1.logger.error(`Error in performSearch (Prebook): ${error.message}`);
