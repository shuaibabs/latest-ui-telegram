...
exports.startDetailSalesFlow = startDetailSalesFlow;
exports.registerDetailSalesFlow = registerDetailSalesFlow;
...
function startDetailSalesFlow(bot, chatId) {
    return __awaiter(this, void 0, void 0, function* () {
        (0, sessionManager_1.setSession)(chatId, 'saleDetail', { stage: 'AWAIT_MOBILE' });
        yield bot.sendMessage(chatId, "ℹ️ *Sale Details*\n\nPlease enter the mobile number to show details:", {
            parse_mode: 'Markdown',
            reply_markup: {
...
function registerDetailSalesFlow(router) {
    const bot = router.bot;
    bot.on('message', (msg) => __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        const session = (0, sessionManager_1.getSession)(msg.chat.id, 'saleDetail');
        ...
        try {
            ...
            if (!isUserAdmin && !(profile === null || profile === void 0 ? void 0 : profile.displayName)) {
                ...
                (0, sessionManager_1.clearSession)(chatId, 'saleDetail');
                return;
            }
            ...
            logger_1.logger.error(`Error in detailSalesFlow: ${error.message}`);
            yield bot.sendMessage(chatId, `❌ Error: ${error.message}`);
        }
    }));
    router.registerCallback('sale_detail_cancel', (query) => __awaiter(this, void 0, void 0, function* () {
        (0, sessionManager_1.clearSession)(query.message.chat.id, 'saleDetail');
