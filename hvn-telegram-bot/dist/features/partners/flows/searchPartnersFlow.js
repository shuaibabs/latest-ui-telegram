...
exports.startSearchPartnersFlow = startSearchPartnersFlow;
exports.registerSearchPartnersFlow = registerSearchPartnersFlow;
...
function startSearchPartnersFlow(bot, chatId, username) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, sessionManager_1.setSession)(chatId, 'searchPartners', {
            stage: 'SELECT_TYPE',
            criteria: {}
        });
        yield bot.sendMessage(chatId, "🔍 *Search Partnership Records*\n\nChoose search type:", {
            parse_mode: 'Markdown',
            reply_markup: {
                inline_keyboard: [
...
function registerSearchPartnersFlow(router) {
    const bot = router.bot;
    bot.on('message', (msg) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const session = (0, sessionManager_1.getSession)(msg.chat.id, 'searchPartners');
        ...
        if (session.stage === 'AWAIT_CRITERIA_VAL' && session.currentSetting) {
            ...
            (0, sessionManager_1.setSession)(chatId, 'searchPartners', session);
            ...
            (0, sessionManager_1.clearSession)(chatId, 'searchPartners');
        }
    }));
    router.registerCallback(/^partners_search_type_/, (query) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPartners');
        if (!session)
            return;
        ...
        if (type === 'adv') {
            ...
            (0, sessionManager_1.setSession)(chatId, 'searchPartners', session);
            yield bot.sendMessage(chatId, "*Advanced Partnership Search*\nConfigure your filters:", {
                parse_mode: 'Markdown',
                reply_markup: getCriteriaMenu(session.criteria)
            });
        }
    ...
    router.registerCallback(/^partners_search_set_/, (query) => __awaiter(this, void 0, void 0, function* () {
        var _a;
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPartners');
        if (!session || session.stage !== 'ADV_SEARCH_MENU')
            return;
        const key = (_a = query.data) === null || _a === void 0 ? void 0 : _a.replace('partners_search_set_', '');
    ...
    router.registerCallback('partners_search_apply', (query) => __awaiter(this, void 0, void 0, function* () {
        const chatId = query.message.chat.id;
        const session = (0, sessionManager_1.getSession)(chatId, 'searchPartners');
        if (!session)
            return;
    ...
    router.registerCallback('partners_search_cancel', (query) => __awaiter(this, void 0, void 0, function* () {
        (0, sessionManager_1.clearSession)(query.message.chat.id, 'searchPartners');
...
function performSearch(bot, chatId, criteria, username) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const results = yield (0, partnersService_1.searchPartnershipNumbers)(criteria, employeeName);
            if (results.length === 0) {
                yield bot.sendMessage(chatId, "🔍 No partnership numbers found matching your criteria.");
            }
            else {
            ...
            logger_1.logger.error(`Error in performSearchPartners: ${error.message}`);
